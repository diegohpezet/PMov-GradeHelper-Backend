...
<template>
  <nav class="navbar navbar-expand-md card">
    <div
      class="d-flex w-100 flex-wrap justify-content-between text-align-middle"
    >
      <!-- Header -->
      ...
      <div class="d-flex align-items-center">
        <i
          v-if="isAdmin"
          class="ri-presentation-fill fs-4 me-2 d-none d-sm-inline"
        ></i>
        <i
          v-else
          class="ri-graduation-cap-line fs-4 me-2 d-none d-sm-inline"
        ></i>
        ...
        <div v-if="!isAdmin" class="dropdown">
          <button
            class="btn btn-light ms-1 rounded-circle"
            type="button"
