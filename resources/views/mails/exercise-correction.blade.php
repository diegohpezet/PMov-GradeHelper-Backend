...
<ul>
  <li>
    {{ __('emails.exercise_correction.body.value', [
        'value' => $gradeable->gradable_type === 'App\Models\PassFailGrade'
            ? ($gradeable->gradable->value ? __('emails.exercise_correction.body.passed') : __('emails.exercise_correction.body.failed'))
            : $gradeable->gradable->value
    ]) }}
  </li>
